      ...
      `}>
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <Link href="/" className="text-xl font-bold bg-gradient-to-r from-indigo-400 to-violet-400 text-transparent bg-clip-text hover:from-indigo-300 hover:to-violet-300 transition-all duration-300 font-calsans">
                  EventSeal
                </Link>
              </div>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              href="/events"
              className={`block px-3 py-2 rounded-lg text-base font-medium transition-all duration-200 font-montserrat
                ${pathname === '/events' || pathname.startsWith('/events/')
