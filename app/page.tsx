          ...
          <div className="flex flex-col items-center text-center">
            <div className="space-y-8 max-w-4xl">
              <div className="relative">
                ...
                <h1 className="relative text-5xl md:text-6xl tracking-tight font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-indigo-100 to-violet-200 leading-tight    ">
                  NFT dispenser for events 
                </h1>
              </div>
              <p className="text-xl md:text-2xl text-indigo-100 leading-relaxed mx-auto max-w-3xl  ">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 justify-center mt-10">
                {publicKey ? (
                  <>
                    <Link
                      href="/events"
                      className="group relative inline-flex justify-center items-center px-8 py-4 text-base font-medium rounded-xl overflow-hidden transition-all duration-300 shadow-lg shadow-indigo-900/30 hover:shadow-indigo-900/50 hover:-translate-y-1  "
                    >
                    ...
                    <Link
                      href="/events/create"
                      className="group relative inline-flex justify-center items-center px-8 py-4 text-base font-medium rounded-xl overflow-hidden transition-all duration-300 shadow-lg shadow-indigo-900/10 hover:shadow-indigo-900/30 hover:-translate-y-1  "
                    >
                  ...
                  <div className="relative backdrop-blur-lg bg-indigo-500/10 border border-indigo-400/30 rounded-2xl p-8 max-w-sm mx-auto shadow-xl shadow-indigo-900/20">
                    ...
                    <div className="relative flex flex-col space-y-6 items-center">
                      <div className="text-indigo-100 text-xl font-medium  ">
                      ...
                      <p className="text-sm text-indigo-200">
                        Securely connect your Solana wallet to access all
                        features
                      </p>
                    </div>
                  </div>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-4">
              <div className="bg-background/30 backdrop-blur-md px-4 py-2 rounded-full border border-indigo-500/20 text-indigo-200 text-sm flex items-center shadow-lg shadow-indigo-900/10  ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="group relative bg-background/40 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-indigo-900/30 transform transition-all duration-500 ease-initial hover:-translate-y-2 hover:shadow-indigo-900/10 overflow-hidden mask-b-from-50% hover:mask-none">
              ...
              <p className="text-muted-foreground  ">
                Confirm participation with blockchain-backed verification that's
